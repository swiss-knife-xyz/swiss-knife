export const EXECUTE_CALL_ABI = [
  { inputs: [], name: "NonContractCall", type: "error" },
  { inputs: [], name: "ReturnIndexValueError", type: "error" },
  { inputs: [], name: "SenderNotAdmin", type: "error" },
  { inputs: [], name: "SenderNotOwner", type: "error" },
  { inputs: [], name: "SubIndexValueError", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: "logger",
    outputs: [
      { internalType: "contract DefisaverLogger", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct ExecuteCall.Params",
        name: "params",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "registry",
    outputs: [
      { internalType: "contract DFSRegistry", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
